...
async def get_user_cost_breakdown(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get user cost breakdown: {e}")
...
async def get_cache_performance() -> Dict:
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to get cache performance: {e}")
...
async def get_production_health() -> Dict:
    ...
    try:
        ...
        try:
            ...
            health_status["components"]["cost_tracking"] = {"status": "error", "error": str(e)}
        ...
        try:
            ...
            if _adaptive_router and hasattr(_adaptive_router, 'get_week2_status'):
                ...
                health_status["components"]["adaptive_routing"] = {
                    ...
                    "real_traffic_percentage": adaptive_status["week2_features"]["real_traffic_percentage"],
                    "safety_status": adaptive_status["safety_status"]["status"]
                }
            else:
                health_status["components"]["adaptive_routing"] = {"status": "not_available"}
                
        except Exception as e:
            health_status["components"]["adaptive_routing"] = {"status": "error", "error": str(e)}
            ...
            if _adaptive_router and hasattr(_adaptive_router, 'get_week2_status'):
                ...
                if adaptive_status["performance_comparison"]["data_available"]:
                    ...
                    summary["performance"] = {
                        ...
                        "response_time_improvement": perf["improvements"]["response_time_pct"],
        ...
        try:
            ...
            if _adaptive_router and hasattr(_adaptive_router, 'get_week2_status'):
                ...
                summary["adaptive"] = {
                    ...
                    "safety_status": adaptive_status["safety_status"]["status"],
                    "can_increase_rollout": adaptive_status["rollout_status"]["can_increase"]
                }
            else:
