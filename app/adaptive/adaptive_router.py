...
from app.adaptive.bandit.thompson_sampling import ThompsonSamplingBandit, create_routing_bandit
...
class AdaptiveIntelligentRouter:
    ...
    async def route_query(self, query: str, state: GraphState) -> Any:
        ...
        if shadow_result:
            await self._log_shadow_comparison(query, state, production_result, shadow_result)
