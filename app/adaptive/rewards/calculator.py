...
class SimpleRewardCalculator:
    ...
    def calculate_reward(self, metrics: RouteMetrics) -> Dict:
        ...
        response_score = self._calculate_response_time_score(metrics.response_time_seconds)
        ...
        cost_score = self._calculate_cost_score(metrics.cost_cents) if self.cost_weight > 0 else 0.0
...
class RewardTracker:
    ...
    def get_arm_performance(self, arm_id: str, window_hours: int = 24) -> Dict:
        ...
        recent_rewards = [
            r for r in self.rewards_by_arm[arm_id]
        ...
        return {
            ...
            "success_rate": sum(1 for r in recent_rewards if r["metrics"]["success"]) / len(recent_rewards),
