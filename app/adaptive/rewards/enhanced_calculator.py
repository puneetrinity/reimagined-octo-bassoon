...
from app.adaptive.rewards.calculator import RouteMetrics, SimpleRewardCalculator
...
class EnhancedRewardCalculator:
    ...
    def calculate_enhanced_reward(self, metrics: EnhancedRouteMetrics) -> Dict:
        ...
        reward_breakdown = {
            ...
            "budget_status": {
                ...
                "budget_remaining": self.monthly_budget_usd - self.monthly_spend_tracker,
    ...
    def _calculate_performance_score(self, metrics: EnhancedRouteMetrics) -> float:
        ...
        memory_penalty = max(0, (metrics.memory_usage_mb - 1000) / 1000) * 0.1  # Penalty for >1GB
        cpu_penalty = max(0, (metrics.cpu_utilization - 0.8)) * 0.2  # Penalty for >80% CPU
    ...
    def _calculate_ux_score(self, metrics: EnhancedRouteMetrics) -> float:
        ...
        engagement_score = min(1.0, metrics.followup_questions / 3.0)  # Cap at 3 questions
    ...
    def get_budget_status(self) -> Dict:
        ...
        return {
            ...
            "remaining_budget_usd": self.monthly_budget_usd - self.monthly_spend_tracker,
