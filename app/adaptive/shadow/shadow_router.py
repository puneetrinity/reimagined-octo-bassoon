...
from app.adaptive.rewards.calculator import RewardTracker, RouteMetrics, SimpleRewardCalculator
...
class ShadowRouter:
    ...
    async def route_with_shadow(
        ...
        try:
            ...
            logger.error("production_route_failed", error=str(e), request_id=shadow_request.request_id)
    ...
    async def _execute_shadow_test(
        ...
        try:
            ...
            result_data = await asyncio.wait_for(shadow_task, timeout=self.timeout_seconds)
    ...
    def get_shadow_stats(self) -> Dict:
        ...
        total_attempts = self.shadow_executions + self.shadow_timeouts + self.shadow_errors
